...
if __name__ == '__main__':
    ...
    parser.add_argument('--yolo_model', nargs='+', type=str, default='weights/yolov5s_UAV.pt', help='model.pt path(s)')
    parser.add_argument('--deep_sort_model', type=str, default='resnet50')
    parser.add_argument('--source', type=str, default='C:/Users/TLDX/Desktop/test_image/M0203', help='source')  # file/folder, 0 for webcam
